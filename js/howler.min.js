...
!function() {
        ...
        _enableiOSAudio: function() {
            ...
            if (!t || !e._iOSEnabled && /iPhone|iPad|iPod/i.test(navigator.userAgent)) {
                ...
                var n = function() {
                    ...
                    setTimeout(function() {
                        (i.playbackState === i.PLAYING_STATE || i.playbackState === i.FINISHED_STATE) && (e._iOSEnabled = !0,
                        e.iOSAutoEnable = !1,
    ...
    if (l.prototype = {
        load: function() {
            ...
            e._webAudio)
                ...
                u.addEventListener("canplaythrough", l, !1),
                u.load()
            }
            return e
        },
        ...
        play: function(e, n) {
            ...
            r._loaded ? r._sprite[e] ? (r._inactiveNode(function(i) {
                ...
                var s = i._pos > 0 ? i._pos : r._sprite[e][0] / 1e3
                  , o = 0;
                r._webAudio ? (o = r._sprite[e][1] / 1e3 - i._pos,
                i._pos > 0 && (s = r._sprite[e][0] / 1e3 + s)) : o = r._sprite[e][1] / 1e3 - (s - r._sprite[e][0] / 1e3);
                ...
                if (function() {
                    ...
                    u = setTimeout(function() {
                        !r._webAudio && a && r.stop(t.id).play(e, t.id),
                        r._webAudio && !a && (r._nodeById(t.id).paused = !0,
                        r._nodeById(t.id)._pos = 0,
        ...
        loop: function(e) {
            var t = this;
            return "boolean" == typeof e ? (t._loop = e,
            t) : t._loop
        },
        sprite: function(e) {
            var t = this;
            return "object" == typeof e ? (t._sprite = e,
            t) : t._sprite
        },
        pos: function(e, n) {
            var r = this;
            ...
            if (i)
                return e >= 0 ? (r.pause(n),
                i._pos = e,
                r.play(i._sprite, n),
                r) : r._webAudio ? i._pos + (t.currentTime - r._playStart) : i.currentTime;
            if (e >= 0)
                return r;
        ...
        _drainPool: function() {
            ...
            for (e = t._audioNode.length - 1; e >= 0 && !(5 >= n); e--)
                t._audioNode[e].paused && (t._webAudio && t._audioNode[e].disconnect(0),
                n--,
    ...
    n)
        var c = function(t, n) {
            if (n in e)
                return t._duration = e[n].duration,
                void p(t);
            if (/^data:[^;]+;base64,/.test(n)) {
                for (var r = atob(n.split(",")[1]), i = new Uint8Array(r.length), s = 0; s < r.length; ++s)
                    i[s] = r.charCodeAt(s);
                h(i.buffer, t, n)
            } else {
          ...
          , d = function(n, r, i) {
            ...
            r[0] && (s.bufferSource.loopStart = r[1],
    ...
    exports.Howl = l),
    "undefined" != typeof window && (window.Howler = f,
    window.Howl = l)
}();
